...
class ApplicationModel(BaseModel):
    ...
    resume_url: Optional[str] = Field(
        None,
        description="Resume URL (can override profile resume)"
    )
    ...
    interview_type: Optional[str] = Field(
        None,
        description="'now' for immediate or 'scheduled' for later"
    )
    interview_scheduled_at: Optional[datetime] = Field(
        None,
        description="Scheduled interview datetime"
    )
    interview_status: Optional[str] = Field(
        None,
        description="'pending', 'scheduled', 'in_progress', 'completed'"
    )
    ...
    interview_feedback: Optional[dict] = Field(
        None,
        description="Detailed feedback from AI interview"
    )
    ai_recommendation: Optional[str] = Field(
        None,
        description="AI recommendation: strong_hire, hire, maybe, no_hire"
    )
    interview_scores: Optional[dict] = Field(
        None,
        description="Confidence, technical, clarity scores"
    )
    interview_completed_at: Optional[datetime] = Field(
        None,
        description="When interview was completed"
    )
